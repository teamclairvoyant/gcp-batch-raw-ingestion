  ...
  stages {
    stage('version') {
      steps {
        ...
        sh 'ls  -ltrh /bitnami/jenkins/home/workspace/dataflow-python-etl/dataflow'
      }
    }
      ...
      steps {
        dir('/bitnami/jenkins/home/workspace/dataflow-etl/dataflow/'){
         // slackSend color: 'good', message: "Hi <@$userId> Running setup.py"
          sh 'python3 /bitnami/jenkins/home/workspace/dataflow-python-etl/dataflow/setup.py install --user'
        }
      }
    }
    stage('build the template and deploy on gcs') {
      steps {
       dir('/bitnami/jenkins/home/workspace/dataflow-python-etl/dataflow/'){
